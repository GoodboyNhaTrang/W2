...
<body>
  ...
  <section class="search-form">
    <form action="" method="get">
      ...
      <input type="number" name="minPrice" placeholder="min price" class="box-price"
        value="<?php if (isset($_GET['minPrice'])) echo $_GET['minPrice'] ?>"><br>
      <input type="number" name="maxPrice" placeholder="max price" class="box-price"
        value="<?php if (isset($_GET['maxPrice'])) echo $_GET['maxPrice'] ?>"><br>
